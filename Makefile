...
help: ## Show this help message
	...
	@echo ""
	@echo "Core Commands:"
	@echo -e "  $(COLOR)make up$(COLOR_RESET)      - Start all services"
	@echo -e "  $(COLOR)make down$(COLOR_RESET)    - Stop and remove all containers"
	@echo -e "  $(COLOR)make build$(COLOR_RESET)   - Build or rebuild Docker images"
	@echo -e "  $(COLOR)make init$(COLOR_RESET)    - Initialize the project (copies .env.docker)"
	@echo -e "  $(COLOR)make restart$(COLOR_RESET) - Restart all services"
	@echo -e "  $(COLOR)make ps$(COLOR_RESET)      - Show status of all services"
	@echo -e "  $(COLOR)make logs$(COLOR_RESET)    - Show logs from all running services"
	@echo ""
	@echo "Service Interaction:"
	@echo -e "  $(COLOR)make php$(COLOR_RESET)     - Enter the PHP container (bash)"
	@echo -e "  $(COLOR)make apache$(COLOR_RESET)  - Enter the Apache container (sh)"
	@echo -e "  $(COLOR)make mysql$(COLOR_RESET)   - Enter the MySQL container (bash)"
	@echo -e "  $(COLOR)make exec$(COLOR_RESET)    - Execute a command in a service"
	@echo ""
	@echo "Examples:"
